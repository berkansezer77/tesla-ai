class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha339-live-trip-ai-interval-test-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha339")) {
  customElements.define("pom-tesla-report-panel-alpha339", PomTeslaReportPanel);
}
