class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha359-top-area-language-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha359")) {
  customElements.define("pom-tesla-report-panel-alpha359", PomTeslaReportPanel);
}
