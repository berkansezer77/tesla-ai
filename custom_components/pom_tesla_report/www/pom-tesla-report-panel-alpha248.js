class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha248-ai-story-detail-records";
...
if (!customElements.get("pom-tesla-report-panel-alpha248")) {
  customElements.define("pom-tesla-report-panel-alpha248", PomTeslaReportPanel);
}
