class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha274-support-report-cleanup";
...
if (!customElements.get("pom-tesla-report-panel-alpha274")) {
  customElements.define("pom-tesla-report-panel-alpha274", PomTeslaReportPanel);
}
