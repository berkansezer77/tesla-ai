class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha281-drive-dashboard-responsive-grid";
...
.ai-role-meta-line { color:#fca5a5; }
  ...
  _render() {
    ...
    ["parked", "charging", "driving", "drive_vehicle"].forEach((slot) => {
...
if (!customElements.get("pom-tesla-report-panel-alpha281")) {
  customElements.define("pom-tesla-report-panel-alpha281", PomTeslaReportPanel);
}
