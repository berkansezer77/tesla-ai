class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha322-live-trip-ai-panel-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha322")) {
  customElements.define("pom-tesla-report-panel-alpha322", PomTeslaReportPanel);
}
