class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha333-dashboard-upload-immediate-apply";
...
if (!customElements.get("pom-tesla-report-panel-alpha333")) {
  customElements.define("pom-tesla-report-panel-alpha333", PomTeslaReportPanel);
}
