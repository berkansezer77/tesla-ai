class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha293-drive-prepaint-fullscreen";
...
if (!customElements.get("pom-tesla-report-panel-alpha293")) {
  customElements.define("pom-tesla-report-panel-alpha293", PomTeslaReportPanel);
}
