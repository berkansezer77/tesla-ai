class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha255-charge-new-record-reset";
...
if (!customElements.get("pom-tesla-report-panel-alpha255")) {
  customElements.define("pom-tesla-report-panel-alpha255", PomTeslaReportPanel);
}
