class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha355-charge-popup-center-close-align";
...
if (!customElements.get("pom-tesla-report-panel-alpha355")) {
  customElements.define("pom-tesla-report-panel-alpha355", PomTeslaReportPanel);
}
