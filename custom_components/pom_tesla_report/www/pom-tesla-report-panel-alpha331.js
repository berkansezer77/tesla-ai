class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha332-global-wait-modal-i18n";
...
if (!customElements.get("pom-tesla-report-panel-alpha331")) {
  customElements.define("pom-tesla-report-panel-alpha331", PomTeslaReportPanel);
}
