class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha351-live-trip-language-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha351")) {
  customElements.define("pom-tesla-report-panel-alpha351", PomTeslaReportPanel);
}
