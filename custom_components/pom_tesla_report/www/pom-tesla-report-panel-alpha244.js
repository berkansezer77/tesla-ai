class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha244-map-theme-visual-fix";
  ...
  _t(key) {
    const dict = {
      tr: {
        ...
        dashboardMapThemeDark: "Dark / koyu okunabilir harita",
        dashboardMapThemeLight: "Light / gündüz haritası",
        dashboardMapThemeNote: "Light seçildiğinde harita açıkken üst alan yazıları yumuşak koyu renge, orta hız da cam/beyaz görünüme geçer.",
      ...
      en: {
        ...
        dashboardMapThemeDark: "Dark / readable dark map",
        dashboardMapThemeLight: "Light / daytime map",
        dashboardMapThemeNote: "When Light is selected, top-area text switches to a softer dark color and the center gauge uses a frosted light look while the map is open.",
...
if (!customElements.get("pom-tesla-report-panel-alpha244")) {
  customElements.define("pom-tesla-report-panel-alpha244", PomTeslaReportPanel);
}
