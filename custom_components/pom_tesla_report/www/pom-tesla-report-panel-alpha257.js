class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha257-manual-trip-filter";
...
if (!customElements.get("pom-tesla-report-panel-alpha257")) {
  customElements.define("pom-tesla-report-panel-alpha257", PomTeslaReportPanel);
}
