class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha345-live-trip-ai-card-cache-bust";
...
if (!customElements.get("pom-tesla-report-panel-alpha345")) {
  customElements.define("pom-tesla-report-panel-alpha345", PomTeslaReportPanel);
}
