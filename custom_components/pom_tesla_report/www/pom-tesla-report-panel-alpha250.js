class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha250-test-drive-log-tools";
...
if (!customElements.get("pom-tesla-report-panel-alpha250")) {
  customElements.define("pom-tesla-report-panel-alpha250", PomTeslaReportPanel);
}
