class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha178-manual-tracking-records";
  ...
  _render() {
    ...
    this.shadowRoot.getElementById("tabManual")?.addEventListener("click", () => { this._activeTab = "manual"; this._status = ""; this._error = ""; this._render(); });
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha178", PomTeslaReportPanel);
}
