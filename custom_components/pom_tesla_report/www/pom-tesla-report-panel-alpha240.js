class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha240-fix-black-screen-health-ui";
...
if (!customElements.get("pom-tesla-report-panel-alpha240")) {
  customElements.define("pom-tesla-report-panel-alpha240", PomTeslaReportPanel);
}
