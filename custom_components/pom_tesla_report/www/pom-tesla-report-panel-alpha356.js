class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha356-charge-popup-close-inside-align";
...
if (!customElements.get("pom-tesla-report-panel-alpha356")) {
  customElements.define("pom-tesla-report-panel-alpha356", PomTeslaReportPanel);
}
