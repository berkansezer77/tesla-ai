class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha360-alerts-builtin-telegram-listener-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha360")) {
  customElements.define("pom-tesla-report-panel-alpha360", PomTeslaReportPanel);
}
