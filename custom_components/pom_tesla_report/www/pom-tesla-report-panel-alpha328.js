class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha328-live-trip-ai-panel-tidy";
...
if (!customElements.get("pom-tesla-report-panel-alpha328")) {
  customElements.define("pom-tesla-report-panel-alpha328", PomTeslaReportPanel);
}
