class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha362-tesla-ai-name-cache-hide";
...
if (!customElements.get("pom-tesla-report-panel-alpha362")) {
  customElements.define("pom-tesla-report-panel-alpha362", PomTeslaReportPanel);
}
