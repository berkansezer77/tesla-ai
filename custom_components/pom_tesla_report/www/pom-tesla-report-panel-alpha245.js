class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha245-map-opacity-yaml-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha245")) {
  customElements.define("pom-tesla-report-panel-alpha245", PomTeslaReportPanel);
}
