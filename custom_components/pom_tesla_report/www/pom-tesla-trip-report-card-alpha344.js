class PomTeslaTripReportCard extends HTMLElement {
  static get version() { return '1.9.14-alpha348'; }
  constructor() {
    super();
  ...
  _liveAiPanelData(live, distanceText) {
    ...
    const computedWaitingText = tripKm <= 0.05
      ? `İlk Live Trip yorumu ${segmentLabel} km civarında hazır olacak.`
      : `Bir sonraki Live Trip yorumu için yaklaşık ${remainingKm.toFixed(1)} km kaldı.`;
            ...
            <div class="ai-panel-inner">
              ...
              <div class="ai-progress-wrap">
                <div class="ai-progress-head">
                  ...
                  <span>${this._escapeHtml(aiPanel.remainingKm > 0.01 ? `Sonraki yorum ~${(Math.abs(aiPanel.nextTarget - Math.round(aiPanel.nextTarget)) < 0.05 ? aiPanel.nextTarget.toFixed(0) : aiPanel.nextTarget.toFixed(1))} km` : 'Yorum eşik noktası aşıldı')}</span>
                </div>
