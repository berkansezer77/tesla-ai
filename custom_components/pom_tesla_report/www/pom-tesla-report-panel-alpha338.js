class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha338-live-trip-ai-test-intervals";
...
if (!customElements.get("pom-tesla-report-panel-alpha338")) {
  customElements.define("pom-tesla-report-panel-alpha338", PomTeslaReportPanel);
}
