class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha349-candidate-filter-live-ai-detail";
...
if (!customElements.get("pom-tesla-report-panel-alpha349")) {
  customElements.define("pom-tesla-report-panel-alpha349", PomTeslaReportPanel);
}
