class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha213-minimal-options-clean-device";
  ...
  _t(key) {
    const dict = {
      tr: {
        ...
        autoFindStarted: "Auto Find arka planda başlatıldı. Panel açık kalabilir; HA kilitlenmez.",
      ...
      en: {
        ...
        autoFindStarted: "Auto Find started in the background. The panel can stay open; HA will not be blocked.",
  ...
  async _pollAutoFindJob(kind) {
    const label = kind === "dashboard" ? this._t("dashboardEntityManager") : this._t("aiEntityManager");
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha213", PomTeslaReportPanel);
}
