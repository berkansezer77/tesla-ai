class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha246-trip-report-stability";
  ...
  _t(key) {
    const dict = {
      tr: {
        ...
        dashboardMapThemeDark: "Dark / daha koyu okunabilir harita",
        dashboardMapThemeLight: "Light / gündüz haritası",
        dashboardMapThemeNote: "Light modda üst alan mavi/teal kontrastlı ve dekoratif görünür; Dark mod dashboard haritasını daha güçlü koyulaştırır. Harita saydamlık butonu artık seçili arka plan görselini daha fazla gösterir.",
      ...
      en: {
        ...
        dashboardMapThemeDark: "Dark / stronger readable dark map",
        dashboardMapThemeLight: "Light / daytime map",
        dashboardMapThemeNote: "Light mode uses a soft blue/teal high-contrast top area; Dark mode forces a stronger dashboard-only dark map. The map transparency button now shows more of the selected background image.",
...
if (!customElements.get("pom-tesla-report-panel-alpha246")) {
  customElements.define("pom-tesla-report-panel-alpha246", PomTeslaReportPanel);
}
