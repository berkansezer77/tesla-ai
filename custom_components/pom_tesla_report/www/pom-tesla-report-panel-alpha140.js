class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha140-pointerdown-dashboard-menu";
  ...
  _handleDelegatedPointerDown(ev) {
    ...
    if (dashboardSection) {
      ...
      if (this._dashboardSettingsSection !== section) {
    ...
    if (settingsTab) {
      ...
      if (this._activeSettingsTab !== tab) {
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha140", PomTeslaReportPanel);
}
