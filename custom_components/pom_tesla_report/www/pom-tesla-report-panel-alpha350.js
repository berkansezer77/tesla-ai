class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha350-live-ai-rich-comment-test";
...
if (!customElements.get("pom-tesla-report-panel-alpha350")) {
  customElements.define("pom-tesla-report-panel-alpha350", PomTeslaReportPanel);
}
