class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha340-live-trip-ai-test-save-fix";
...
.ai-role-meta-line { color:#fca5a5; }
  ...
  _render() {
    ...
    this.shadowRoot.getElementById("trip_live_trip_ai_segment_distance_km")?.addEventListener("change", (ev) => {
...
if (!customElements.get("pom-tesla-report-panel-alpha340")) {
  customElements.define("pom-tesla-report-panel-alpha340", PomTeslaReportPanel);
}
