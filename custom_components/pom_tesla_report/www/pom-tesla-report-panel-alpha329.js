class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha329-live-trip-ai-comment-focus";
...
if (!customElements.get("pom-tesla-report-panel-alpha329")) {
  customElements.define("pom-tesla-report-panel-alpha329", PomTeslaReportPanel);
}
