class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha320-cautious-traffic-analysis";
...
if (!customElements.get("pom-tesla-report-panel-alpha320")) {
  customElements.define("pom-tesla-report-panel-alpha320", PomTeslaReportPanel);
}
