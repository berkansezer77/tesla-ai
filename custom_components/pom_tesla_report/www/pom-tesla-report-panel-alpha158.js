class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha158-no-resume-debug";
  ...
  _renderYoutubeDrivingBackgroundCard(cfg = {}) {
    return `
      <div class="dashboard-upload-card youtube-bg-card">
        ...
        <div class="note">Tesla Safe YouTube: HA içinde yt-dlp + ffmpeg ile WebSocket MPEG-TS üretir, dashboard ise JSMpeg Canvas2D ile gösterir. Alpha158: resume/seek kapalı. Kısa videoda beyaz ekranı engellemek için güvenli WebSocket/JSMpeg moda dönüldü.</div>
      </div>
    `;
  }
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha158", PomTeslaReportPanel);
}
