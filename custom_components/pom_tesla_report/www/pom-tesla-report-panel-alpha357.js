class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha357-live-ai-popup-reader";
...
if (!customElements.get("pom-tesla-report-panel-alpha357")) {
  customElements.define("pom-tesla-report-panel-alpha357", PomTeslaReportPanel);
}
