class PomTeslaTripReportCard extends HTMLElement {
  static get version() { return '1.9.3-alpha328'; }
  constructor() {
    super();
  ...
  static getStubConfig() {
    return {
      type: 'custom:pom-tesla-trip-report-card-alpha328',
      live_trip_entity: '',
      speed_entity: '',
      odometer_entity: '',
      energy_remaining_entity: '',
...
if (!customElements.get('pom-tesla-trip-report-card-alpha328')) {
  customElements.define('pom-tesla-trip-report-card-alpha328', PomTeslaTripReportCard);
}
...
window.customCards.push({
  type: 'pom-tesla-trip-report-card-alpha328',
  name: 'POM Tesla Trip Report Card alpha328',
