class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha318-battery-left-padding";
...
if (!customElements.get("pom-tesla-report-panel-alpha318")) {
  customElements.define("pom-tesla-report-panel-alpha318", PomTeslaReportPanel);
}
