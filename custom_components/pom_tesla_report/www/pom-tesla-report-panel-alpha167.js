class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha167-1080p-start-seconds";
    ...
    return `
      <div class="dashboard-upload-card youtube-bg-card">
        ...
        <div class="field-grid single-col">
          ...
          <div><label>Tesla Safe kalite</label><select id="dashboard_youtube_driving_bg_quality">
            ...
            <option value="1080" ${String(cfg.quality || "480") === "1080" ? "selected" : ""}>1080p</option>
          </select></div>
        ...
        <div class="note">Tesla Safe YouTube: HA içinde yt-dlp + ffmpeg ile WebSocket MPEG-TS üretir, dashboard ise JSMpeg Canvas2D ile gösterir. Alpha160: yt-dlp resolve cache eklendi. Reconnect olursa YouTube yeniden çözümlenmeden hızlıca kaldığı yere yakın devam eder.</div>
      </div>
    `;
  }
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha167", PomTeslaReportPanel);
}
