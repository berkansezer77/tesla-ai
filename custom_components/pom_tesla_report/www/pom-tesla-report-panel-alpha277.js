class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha277-drive-dashboard-sidebar-fit";
...
if (!customElements.get("pom-tesla-report-panel-alpha277")) {
  customElements.define("pom-tesla-report-panel-alpha277", PomTeslaReportPanel);
}
