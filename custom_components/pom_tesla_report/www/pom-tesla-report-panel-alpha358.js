class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha358-charge-popup-tap-close";
...
if (!customElements.get("pom-tesla-report-panel-alpha358")) {
  customElements.define("pom-tesla-report-panel-alpha358", PomTeslaReportPanel);
}
