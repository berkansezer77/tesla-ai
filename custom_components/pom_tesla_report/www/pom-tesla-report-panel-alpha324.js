class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha324-live-trip-ai-original-card-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha324")) {
  customElements.define("pom-tesla-report-panel-alpha324", PomTeslaReportPanel);
}
