class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha304-upload-tire-bg";
...
if (!customElements.get("pom-tesla-report-panel-alpha304")) {
  customElements.define("pom-tesla-report-panel-alpha304", PomTeslaReportPanel);
}
