class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha335-telegram-trip-periods-dedupe";
...
if (!customElements.get("pom-tesla-report-panel-alpha335")) {
  customElements.define("pom-tesla-report-panel-alpha335", PomTeslaReportPanel);
}
