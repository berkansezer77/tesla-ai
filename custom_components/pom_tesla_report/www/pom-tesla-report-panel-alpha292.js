class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha292-app-switcher-no-kiosk";
...
if (!customElements.get("pom-tesla-report-panel-alpha292")) {
  customElements.define("pom-tesla-report-panel-alpha292", PomTeslaReportPanel);
}
