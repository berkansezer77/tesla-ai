class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha353-charge-card-size-close-tune";
...
if (!customElements.get("pom-tesla-report-panel-alpha353")) {
  customElements.define("pom-tesla-report-panel-alpha353", PomTeslaReportPanel);
}
