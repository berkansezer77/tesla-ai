class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha342-live-trip-ai-save-card-rollback";
...
if (!customElements.get("pom-tesla-report-panel-alpha342")) {
  customElements.define("pom-tesla-report-panel-alpha342", PomTeslaReportPanel);
}
