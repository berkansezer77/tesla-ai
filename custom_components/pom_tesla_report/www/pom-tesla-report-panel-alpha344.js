class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha344-live-trip-ai-runtime-state-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha344")) {
  customElements.define("pom-tesla-report-panel-alpha344", PomTeslaReportPanel);
}
