class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha155-dashboard-safe-youtube-canvas";
  ...
  _renderYoutubeDrivingBackgroundCard(cfg = {}) {
    return `
      <div class="dashboard-upload-card youtube-bg-card">
        ...
        <div class="note">Tesla Safe YouTube: HA içinde yt-dlp + ffmpeg ile WebSocket MPEG-TS üretir, dashboard ise JSMpeg Canvas2D ile gösterir. D modunda video gibi durmaması için tasarlanmıştır.</div>
      </div>
    `;
  }
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha155", PomTeslaReportPanel);
}
