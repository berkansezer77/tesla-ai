class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha348-built-in-telegram-trip-ai-safe-send";
...
if (!customElements.get("pom-tesla-report-panel-alpha348")) {
  customElements.define("pom-tesla-report-panel-alpha348", PomTeslaReportPanel);
}
