class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha336-weekly-trip-render-layout-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha336")) {
  customElements.define("pom-tesla-report-panel-alpha336", PomTeslaReportPanel);
}
