class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha343-live-trip-ai-test-target-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha343")) {
  customElements.define("pom-tesla-report-panel-alpha343", PomTeslaReportPanel);
}
