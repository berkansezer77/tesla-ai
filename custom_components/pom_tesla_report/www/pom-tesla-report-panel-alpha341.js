class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha341-live-trip-ai-interval-reliable-test";
...
if (!customElements.get("pom-tesla-report-panel-alpha341")) {
  customElements.define("pom-tesla-report-panel-alpha341", PomTeslaReportPanel);
}
