class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha354-charge-popup-width-close-position";
...
if (!customElements.get("pom-tesla-report-panel-alpha354")) {
  customElements.define("pom-tesla-report-panel-alpha354", PomTeslaReportPanel);
}
