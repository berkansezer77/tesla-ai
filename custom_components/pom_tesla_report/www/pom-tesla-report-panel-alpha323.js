class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha323-live-trip-ai-click-fix-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha323")) {
  customElements.define("pom-tesla-report-panel-alpha323", PomTeslaReportPanel);
}
