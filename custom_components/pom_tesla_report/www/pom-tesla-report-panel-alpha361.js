class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha361-trip-menu-cleanup";
...
if (!customElements.get("pom-tesla-report-panel-alpha361")) {
  customElements.define("pom-tesla-report-panel-alpha361", PomTeslaReportPanel);
}
