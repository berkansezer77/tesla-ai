class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha253-ai-story-clarity";
...
if (!customElements.get("pom-tesla-report-panel-alpha253")) {
  customElements.define("pom-tesla-report-panel-alpha253", PomTeslaReportPanel);
}
