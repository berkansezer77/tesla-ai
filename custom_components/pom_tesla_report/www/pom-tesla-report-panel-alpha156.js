class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha156-stable-youtube-iframe";
  ...
  _renderYoutubeDrivingBackgroundCard(cfg = {}) {
    return `
      <div class="dashboard-upload-card youtube-bg-card">
        ...
        <div class="note">Tesla Safe YouTube: HA içinde yt-dlp + ffmpeg ile WebSocket MPEG-TS üretir, dashboard ise JSMpeg Canvas2D ile gösterir. Alpha156: iframe artık conditional card ile yok edilmez; görünürlük CSS ile yönetilir, böylece video başa dönmez.</div>
      </div>
    `;
  }
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha156", PomTeslaReportPanel);
}
