class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha247-legacy-map-restore";
...
if (!customElements.get("pom-tesla-report-panel-alpha247")) {
  customElements.define("pom-tesla-report-panel-alpha247", PomTeslaReportPanel);
}
