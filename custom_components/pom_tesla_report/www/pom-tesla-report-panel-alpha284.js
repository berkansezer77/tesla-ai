class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha284-dashboard-switcher";
...
if (!customElements.get("pom-tesla-report-panel-alpha284")) {
  customElements.define("pom-tesla-report-panel-alpha284", PomTeslaReportPanel);
}
