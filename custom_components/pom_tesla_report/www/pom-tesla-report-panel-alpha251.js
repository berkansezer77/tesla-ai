class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha251-distinct-test-routes";
...
if (!customElements.get("pom-tesla-report-panel-alpha251")) {
  customElements.define("pom-tesla-report-panel-alpha251", PomTeslaReportPanel);
}
