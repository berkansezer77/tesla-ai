class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha327-live-trip-ai-resource-bridge";
...
if (!customElements.get("pom-tesla-report-panel-alpha327")) {
  customElements.define("pom-tesla-report-panel-alpha327", PomTeslaReportPanel);
}
