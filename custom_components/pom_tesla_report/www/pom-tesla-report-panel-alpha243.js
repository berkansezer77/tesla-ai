class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha243-health-map-theme";
  ...
  _t(key) {
    const dict = {
      tr: {
        ...
        dashboardMapThemeDark: "Dark / koyu harita",
        dashboardMapThemeLight: "Light / gündüz haritası",
        dashboardMapThemeNote: "Light seçildiğinde harita açıkken üst alan yazıları siyah ve kontrastlı yapılır.",
      ...
      en: {
        ...
        dashboardMapThemeNote: "When Light is selected, top-area text becomes dark and high-contrast while the map is open.",
...
if (!customElements.get("pom-tesla-report-panel-alpha243")) {
  customElements.define("pom-tesla-report-panel-alpha243", PomTeslaReportPanel);
}
