class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha347-telegram-trip-send-helper-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha347")) {
  customElements.define("pom-tesla-report-panel-alpha347", PomTeslaReportPanel);
}
