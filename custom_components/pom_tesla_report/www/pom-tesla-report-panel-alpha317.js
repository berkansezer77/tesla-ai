class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha317-grid-version-separator-fix";
...
if (!customElements.get("pom-tesla-report-panel-alpha317")) {
  customElements.define("pom-tesla-report-panel-alpha317", PomTeslaReportPanel);
}
