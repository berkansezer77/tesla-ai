class PomTeslaTripReportCard extends HTMLElement {
  static get version() { return '1.9.6-alpha339'; }
  constructor() {
    super();
  ...
  static getStubConfig() {
    return {
      type: 'custom:pom-tesla-trip-report-card-alpha339',
      live_trip_entity: '',
      speed_entity: '',
      odometer_entity: '',
      energy_remaining_entity: '',
...
window.customCards.push({
  type: 'pom-tesla-trip-report-card-alpha339',
  name: 'POM Tesla Trip Report Card alpha339',
