class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha294-switcher-update-speed-source";
...
if (!customElements.get("pom-tesla-report-panel-alpha294")) {
  customElements.define("pom-tesla-report-panel-alpha294", PomTeslaReportPanel);
}
