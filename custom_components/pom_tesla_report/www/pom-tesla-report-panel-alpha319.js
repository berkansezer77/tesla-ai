class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha319-drive-i18n";
...
if (!customElements.get("pom-tesla-report-panel-alpha319")) {
  customElements.define("pom-tesla-report-panel-alpha319", PomTeslaReportPanel);
}
