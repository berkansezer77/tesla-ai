class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha346-live-trip-card-stable-restore";
...
if (!customElements.get("pom-tesla-report-panel-alpha346")) {
  customElements.define("pom-tesla-report-panel-alpha346", PomTeslaReportPanel);
}
