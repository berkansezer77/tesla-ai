class PomTeslaTripReportCard extends HTMLElement {
  static get version() { return '1.9.4-alpha329'; }
  constructor() {
    super();
  ...
  static getStubConfig() {
    return {
      type: 'custom:pom-tesla-trip-report-card-alpha329',
      live_trip_entity: '',
      speed_entity: '',
      odometer_entity: '',
      energy_remaining_entity: '',
...
if (!customElements.get('pom-tesla-trip-report-card-alpha329')) {
  customElements.define('pom-tesla-trip-report-card-alpha329', PomTeslaTripReportCard);
}
...
window.customCards.push({
  type: 'pom-tesla-trip-report-card-alpha329',
  name: 'POM Tesla Trip Report Card alpha329',
