class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha325-live-trip-ai-cache-bust";
...
if (!customElements.get("pom-tesla-report-panel-alpha325")) {
  customElements.define("pom-tesla-report-panel-alpha325", PomTeslaReportPanel);
}
