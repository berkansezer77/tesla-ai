class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha159-safe-resume-duration";
  ...
  _renderYoutubeDrivingBackgroundCard(cfg = {}) {
    return `
      <div class="dashboard-upload-card youtube-bg-card">
        ...
        <div class="note">Tesla Safe YouTube: HA içinde yt-dlp + ffmpeg ile WebSocket MPEG-TS üretir, dashboard ise JSMpeg Canvas2D ile gösterir. Alpha159: güvenli resume aktif. Backend video süresini bilir; yeniden bağlantıda süreyi aşmadan kaldığı yere yakın devam eder.</div>
      </div>
    `;
  }
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha159", PomTeslaReportPanel);
}
