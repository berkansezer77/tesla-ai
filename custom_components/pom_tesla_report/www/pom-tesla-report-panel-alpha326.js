class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha326-live-trip-ai-versioned-card";
...
if (!customElements.get("pom-tesla-report-panel-alpha326")) {
  customElements.define("pom-tesla-report-panel-alpha326", PomTeslaReportPanel);
}
