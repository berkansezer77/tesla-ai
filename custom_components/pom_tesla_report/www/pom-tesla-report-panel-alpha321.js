class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha321-ai-user-address";
...
if (!customElements.get("pom-tesla-report-panel-alpha321")) {
  customElements.define("pom-tesla-report-panel-alpha321", PomTeslaReportPanel);
}
