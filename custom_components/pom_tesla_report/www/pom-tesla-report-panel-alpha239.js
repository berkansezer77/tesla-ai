class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha239-live-health-card";
  ...
  _t(key) {
    const dict = {
      tr: {
        ...
        healthWaiting: this._t("healthWaiting"),
...
if (!customElements.get("pom-tesla-report-panel")) {
  customElements.define("pom-tesla-report-panel-alpha239", PomTeslaReportPanel);
}
