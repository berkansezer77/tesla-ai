class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha334-candidate-trip-short-maneuver";
...
if (!customElements.get("pom-tesla-report-panel-alpha334")) {
  customElements.define("pom-tesla-report-panel-alpha334", PomTeslaReportPanel);
}
