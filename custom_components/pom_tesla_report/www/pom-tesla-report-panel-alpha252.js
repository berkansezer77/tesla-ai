class PomTeslaReportPanel extends HTMLElement {
  constructor() {
    ...
    this._frontendBuild = "alpha252-short-trip-traffic-ai";
...
if (!customElements.get("pom-tesla-report-panel-alpha252")) {
  customElements.define("pom-tesla-report-panel-alpha252", PomTeslaReportPanel);
}
